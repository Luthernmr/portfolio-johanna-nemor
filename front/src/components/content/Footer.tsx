        ...
        <Flex height={ "40vh"} width={"100%"} flexDirection={{ base: "column", lg:"row"}} backgroundColor={"purple.100"} p={{base :"5", xl:"0"}}>
            <Center width={{ base: "100%", lg:"70%"}}   h={{ base: "100%", lg:"100%"}}  flexDirection={"column"} position={"relative"}>
                <Box  width={{ base:"100%", lg:"50%"}}  textAlign={{base:'center', lg:'start'}}  ml={{base:"", lg:"10em"}}>
                    <Heading fontFamily={'century-gothic'} lineHeight={"1.2em"} width={'100%'} size={{ base: "md", lg: "md", xl: "lg",  }} color={"#B131FA"}>Envie de se rencontrer ?</Heading>
                    <Text fontSize={{ base:"sm" , lg:"lg"}} color={"black"}>Prenons le temps de discuter autour d'un café.</Text>
                </Box>
            ...
            <Center flexDirection={"column"} width={{ base: "100%", lg:"40%"}} h={{ base: "100%"}} >
                <Text color={"black"} fontSize={{base:"lg", xl:"xl"}} >Contactez-moi !</Text>
